# Server bundle trace report — first-reduction

Generated: 2026-07-19T10:46:31.757Z

## Metrics

- Function traces: 297 (202 API, 95 pages)
- Largest function: app/api/cron/ai-job-worker (331.17 MB)
- Unique traced server files: 470.34 MB
- Next output: 920.07 MB
- Build cache: 878.28 MB
- Public assets: 226.40 MB
- Build duration: 146.6 s
...
4. 330.31 MB (482 files) — `app/api/inventory`
5. 330.31 MB (482 files) — `app/api/inventory/[id]`
...
22. 329.84 MB (463 files) — `app/api/health`
23. 329.83 MB (462 files) — `app/api/dress-checker/correction`
24. 329.83 MB (462 files) — `app/api/admin/dress-checker/corrections/export`
25. 329.83 MB (460 files) — `app/api/admin/dress-checker/lifecycle`
26. 329.83 MB (460 files) — `app/api/admin/index-dress-photos`
27. 329.82 MB (459 files) — `app/api/inventory/duplicate-check`
28. 329.79 MB (460 files) — `app/api/admin/dress-checker/feedback`
29. 329.79 MB (460 files) — `app/api/admin/dress-checker/confirm-same-dress`
30. 286.51 MB (436 files) — `app/api/booking/[id]`
