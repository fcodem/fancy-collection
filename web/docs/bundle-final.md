# Server bundle trace report — final-candidate

Generated: 2026-07-19T11:15:42.661Z
...
4. 330.21 MB (468 files) — `app/api/admin/ai-health`
5. 330.21 MB (468 files) — `app/api/admin/ai/settings`
6. 330.21 MB (468 files) — `app/api/admin/recognition/rebuild`
7. 330.21 MB (468 files) — `app/api/admin/inventory-ai-profile/[id]/refresh-fingerprints`
8. 330.21 MB (468 files) — `app/api/admin/inventory-ai-profile/[id]/refresh-embeddings`
9. 330.21 MB (468 files) — `app/api/admin/ai/enhancement/reset-all`
10. 330.21 MB (468 files) — `app/api/admin/inventory-ai-profile/[id]/refresh-metadata`
11. 330.21 MB (468 files) — `app/api/admin/inventory-ai-profile/[id]/regenerate`
12. 330.21 MB (468 files) — `app/api/admin/ai/enhancement/retry`
13. 330.21 MB (468 files) — `app/api/admin/recognition/retry-failed`
14. 330.21 MB (468 files) — `app/api/admin/recognition/queue`
15. 329.89 MB (473 files) — `app/api/inventory/photo-search`
16. 329.89 MB (473 files) — `app/api/admin/recognition/search-diagnostics`
17. 329.88 MB (468 files) — `app/api/admin/ai-debug`
18. 329.88 MB (468 files) — `app/api/admin/dress-checker-debug`
19. 329.86 MB (466 files) — `app/api/admin/ai-indexing`
20. 329.83 MB (462 files) — `app/api/dress-checker/correction`
21. 329.83 MB (462 files) — `app/api/admin/dress-checker/corrections/export`
22. 329.83 MB (460 files) — `app/api/admin/dress-checker/lifecycle`
23. 329.83 MB (460 files) — `app/api/admin/index-dress-photos`
24. 329.82 MB (459 files) — `app/api/inventory/duplicate-check`
25. 329.79 MB (460 files) — `app/api/admin/dress-checker/feedback`
26. 329.78 MB (460 files) — `app/api/admin/dress-checker/confirm-same-dress`
27. 286.51 MB (436 files) — `app/api/booking/[id]`
28. 286.45 MB (435 files) — `app/api/return/[id]/save`
29. 286.45 MB (435 files) — `app/api/admin/test-all-slips`
30. 286.45 MB (435 files) — `app/api/booking-delivery/[id]/save`
