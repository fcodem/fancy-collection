...
CREATE INDEX IF NOT EXISTS idx_bookings_dress_name_trgm
  ON bookings USING GIN (dress_name gin_trgm_ops);

CREATE INDEX IF NOT EXISTS idx_bookings_contact1_trgm
  ON bookings USING GIN (contact_1 gin_trgm_ops);

CREATE INDEX IF NOT EXISTS idx_bookings_whatsapp_no_trgm
  ON bookings USING GIN (whatsapp_no gin_trgm_ops);

-- BookingItems table: dress name search joins through here
CREATE INDEX IF NOT EXISTS idx_booking_items_dress_name_trgm
