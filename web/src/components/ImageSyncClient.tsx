      ...
      <div className="card" style={{ marginBottom: 20, border: "1px solid var(--primary)" }}>
        ...
        <div className="card-body">
          ...
          <p style={{ fontSize: 13, color: "var(--text-muted)", marginBottom: 12 }}>
            ...
            For angle-invariant AI dress search, each inventory photo must be indexed

            with the multi-stage identification pipeline (SigLIP + region fingerprints). Run this <strong>once after setup</strong>, and again

            when you add new inventory photos.
          ...
          {indexStatus && (
            ...
            <div style={{ marginBottom: 12, fontSize: 13 }}>
              ...
              <strong style={{ fontSize: 16 }}>{indexStatus.indexed}</strong>

              <span style={{ color: "var(--text-muted)" }}> / {indexStatus.total} photos indexed</span>
          ...
          <div style={{ display: "flex", gap: 10, flexWrap: "wrap" }}>
            ...
            <button
              ...
              disabled={indexRunning || indexStatus?.pending === 0}

            >

              <i className="fa-solid fa-bolt" style={{ marginRight: 6 }} />

              {indexRunning ? "Indexing…" : `Index ${indexStatus?.pending ?? "?"} Pending Items`}
