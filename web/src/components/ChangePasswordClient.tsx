  ...
  return (
    <form onSubmit={submit} className="card" style={{ maxWidth: 480 }}>
      ...
      <div className="card-body" style={{ display: "grid", gap: 16 }}>
        ...
        <div><label className="form-label">New Password</label><input type="password" className="form-control" value={next} onChange={(e) => setNext(e.target.value)} required minLength={4} /></div>
