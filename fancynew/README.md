...
```powershell
cd "C:\Users\asus\OneDrive\Desktop\ssdn soft\fancynew"
pip install -r requirements.txt
```

### 2. Run the app

**Easiest (from project root `ssdn soft`):**
...
**From the `fancynew` folder:**

```powershell
python app.py
```

Or double-click `fancynew\start.bat`.

Open **http://localhost:5000** — keep the terminal window open while using the app.
